...
class PesananKasirPage extends StatefulWidget {
  const PesananKasirPage({super.key});

  @override
  State<PesananKasirPage> createState() => _PesananKasirPageState();
}

class _PesananKasirPageState extends State<PesananKasirPage> {
  ...
  void setVariabel() async {
    ...
    var orderMenuId = await SharePref().getOrderId();

    _orderMenuDetailFuture =
        OrderMenuDetailService().getOrderMenuDetail(orderMenusId: orderMenuId);
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: const BottomAppbar(initialIndex: 3),
